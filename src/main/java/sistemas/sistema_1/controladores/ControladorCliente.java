...
public class ControladorCliente {
    ...
    @GetMapping("/api/cliente/{id}")//Ruta
    public Cliente getByIdl(@PathVariable String id) {
    ...
    @DeleteMapping("/api/cliente/eliminar/{id}")//Ruta
    ...
    @PostMapping("/api/cliente/guardar")//Ruta
